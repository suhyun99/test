...
//        if ( action.equals(MediaStore.INTENT_ACTION_VIDEO_CAMERA) ) {
        if ( action.equals("NATIVE_VIDEO_CAMERA") ) {
            intent = new Intent(activity, VideoCamera.class);
        } else if ( action.equals(MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA) ) {
            intent = new Intent(activity, Camera.class);
        } else {
...
//        startCameraActivity(activity, MediaStore.INTENT_ACTION_VIDEO_CAMERA);
    	startCameraActivity(activity, "NATIVE_VIDEO_CAMERA");
    }

    public static void gotoCameraMode(Activity activity) {
//        startCameraActivity(activity, MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA);
    	startCameraActivity(activity, "NATIVE_CAMERA");
    }
